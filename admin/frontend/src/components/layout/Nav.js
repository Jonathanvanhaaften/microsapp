                        ...
                        <div className="relative flex items-center justify-between h-16">
                            ...
                            <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                                <div className="flex-shrink-0 flex items-center">
                                    <img className="block  h-8 w-auto" src={img} alt="Workflow"></img>
                                    {/* <img className="hidden lg:block h-8 w-auto" src="../../images/logo2.png" alt="Workflow" ></img>C:\Users\Jon\Documents\Projects\microsapp\admin\frontend\src\images\logo2.png */}
                                ...
                                <div className="ml-3 relative">
                                    {/* <div>
                                        <button type="button" className="bg-gray-800 flex text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white" id="user-menu" aria-expanded="false" aria-haspopup="true">
                                            ...
                                            <img className="h-8 w-8 rounded-full" src={img} alt=""></img>
                                        </button>
                                    </div>  */}
